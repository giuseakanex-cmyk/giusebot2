...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    // ==========================================
    if (command === 'sposa') {
        if (!who) return m.reply(`💍 Taggare la persona che vuoi sposare!\n_Es: ${usedPrefix}sposa @utente_`)
...
👉 Scrivi *${usedPrefix}accetta* o *${usedPrefix}rifiuta*
╰━━━━━━✧✦━━━━━━━━╯`.trim()
...
handler.command = ['sposa', 'accetta', 'rifiuta', 'divorzia']
handler.group = true
